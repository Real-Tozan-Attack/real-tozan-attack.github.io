...
var RTA_ReachedMtlist_marker = L.geoJson(RTA_ReachedMtlist_Deta, {
  ...
  onEachFeature: function (feature, layer) {
    layer.bindTooltip(tooltip_properties(feature.properties.山名) + "<br>" + tooltip_properties(feature.properties.走者),{permanent: true, direction: 'top', className: 'RTA_ReachedMtlist-tooltip'});
